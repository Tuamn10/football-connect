...
def seed_demo_data():
    ...
    try:
        ...
        post_4 = get_or_create_post(
            ...
            user_id=player_3.id,
            field_id=field_4.id,
            title="Tìm thủ môn đá sân 5 khu Hoàn Kiếm",
            post_type="find_goalkeeper",
            ...
            required_level="good",
            cost=70000,
            description="Đội thiếu thủ môn, đá vui vẻ, chia tiền sân đều.",
            status="open",
        )
        ...
        post_5 = get_or_create_post(
            ...
            user_id=player_4.id,
            field_id=field_1.id,
            title="Tuyển thêm thành viên cố định đá thứ 4 hàng tuần",
            post_type="recruit_member",
            ...
            required_level="average",
            cost=90000,
            description="Đội đá cố định hàng tuần, cần thêm thành viên tham gia lâu dài.",
            status="open",
        )
